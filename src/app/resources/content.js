...
const person = {
  ...
  role: "Digital Agency | IT Consultant | Software Development",
...
if (typeof window !== "undefined") {
  ...
  themeColor = document.body.getAttribute("data-theme");
...
const home = {
  ...
  subline: (
    <>
      ...
      We’re here to <InlineCode> Make </InlineCode> It Easier.
      <br /> <br />
      <Button
        onClick={''}
